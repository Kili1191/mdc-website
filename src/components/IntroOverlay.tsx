  ...
  useEffect(() => {
    ...
    function tick(ts: number) {
      ...
      if (t < CYCLE) {
        ...
        // n'arrive pas. C'etait la grammaire d'origine, et je l'avais cassee
        // en reecrivant le cycle : les yeux s'ouvraient pendant l'expiration,
        // par-dessus le mot. On ne montre jamais les deux ensemble — la
        // maison ouvre les yeux QUAND on a fini de respirer, pas pendant.
        setEyes(0);
    ...
    <>
      <style>{`
        ...
        /* Au milieu de la maison, comme a l'origine. Il n'y croise rien :
           les yeux restent fermes tant que le mot est visible, et le mot a
           disparu quand ils s'ouvrent. */
