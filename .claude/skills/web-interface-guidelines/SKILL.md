...
description: Vercel's concise MUST/SHOULD/NEVER rules for accessible, fast, delightful web interfaces — keyboard support, hit targets, forms, focus management, animation, layout, content, performance, and design. Use when building or reviewing any UI, form, interaction, or animation, and when auditing accessibility or perceived performance. Source, vercel-labs/web-interface-guidelines.
---
...
These are baseline craft rules, not a visual style. On this repo they sit BELOW
`.claude/skills/taste/SKILL.md`, which owns every aesthetic decision for Maison
du Calme. Where the two disagree on how something should look, `taste` wins.
Where these rules concern accessibility, input handling or performance, they
apply as written.
